...
pub struct Store<T: 'static> {
    ...
    /// [`std::cell::RefCell`]s. This is because functions can be re-entrant
    /// with exclusive but stacked calling contexts. [`std::cell::RefCell`]
    /// and [`std::cell::RefMut`] do not allow for recursive usage by design
